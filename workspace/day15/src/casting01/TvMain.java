...
//		tv.netflix(); //부모 객체의 값은 자식 클래스에 있는 멤버 사용 불가능
		...
		//부모클래스 타입의 참조변수로 자식 클래스 타입의 참조값을 대입하는 것이다 
		
		Tv tv1 = (Tv) new SmartTv(); //부모 타입의 객체에 자식의 참조값을 대입 
		System.out.println(tv1);
//		tv1.netflix();	업캐스팅 되면 자식클래스에 만들어진 멤버는 사용 불가능하다 
		
		//방법2
		Tv tv2 = (Tv) smartTv; 
		//tv2는 SmartTv 클래스의 객체를 참조하지만 업캐스팅으로 인해 Tv 타입으로 취급한다 
...
//		Down Casting은 반드시 Up Casting 된 값으로 해야 한다 
